...
<head>
    ...
    * {
    ...
    .product-image img {
        ...
        height: 100%;
        object-fit: cover;
        /* ทำให้รูปเต็มกรอบโดยไม่บิดเบี้ยว */
        border-radius: 10px;
    }
    ...
    <main class="main-content">
        ...
        <section class="video-section">
            <div class="youtube-container">
                <iframe width="560" height="315" src="https://www.youtube.com/embed/c8OIlRJweGA?si=TxokhJaYy5tusPtY"
        ...
        <section class="products-section">
            ...
            <div class="search-bar">
                <div class="search-left">
                    <input type="text" class="search-input" placeholder="ค้นหาสินค้า เช่น เหล็กเส้น ข้ออ้อย..."
                        id="searchInput">
            ...
            <div class="products-layout">
                ...
                <aside class="filter-sidebar">
                    ...
                    <div class="filter-group">
                        ...
                        <div class="filter-option">
                            <input type="checkbox" id="steel-mesh" value="เหล็กตะแกรง/ตาข่าย"
